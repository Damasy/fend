...
function UpdateUI(apiData) {
    ...
    const score_tag = {
        value: apiData.score_tag,
        description: getScoreTagDescription(apiData.score_tag)
    };
    const agreement = {
        value: apiData.agreement,
        description: getAgreementDescription(apiData.agreement)
    };
    const subjectivity = {
        value: apiData.subjectivity,
        description: getSubjectivityDescription(apiData.subjectivity)
    };
    const confidence = {
        value: apiData.confidence,
        description: getConfidenceDescription(apiData.confidence)
    };
    const irony = {
        value: apiData.irony,
        description: getIronyDescription(apiData.irony)
    };
